...
import fr.isen.cloelacroix.androidsmartdevice.screens.DeviceScreen
...
class DeviceActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = intent.getStringExtra("DEVICE_NAME") ?: "Appareil inconnu"
        val address = intent.getStringExtra("MAC_ADDRESS") ?: "N/A"
